    ...
    <div class="row">
                ...
                <nav class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Ankit Infotech</a>
                        </div>
                        <!-- Navbar Links -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@ankitinfotech.com
                                                        </p>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>DevOps Lead for Product Architecture and Continuous Delivery Strategy at Ankit Infotech. Responsible for architecting end-to-end cloud CI/CD pipelines, automating infrastructure, and delivering scalable enterprise software.</p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@ankitinfotech.com</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
                      ...
                      <%
                          ...
                          String username = auth != null ? auth.getName() : "to Ankit Infotech Portal";
                      %>
